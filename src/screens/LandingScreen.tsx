...
export const LandingScreen = () => {
  ...
  // Auto-close status modal when connected (with 1s delay)
  useEffect(() => {
  ...
  return (
    ...
    >
      ...
      <motion.button
        ...
        className={`absolute top-10 right-10 flex items-center gap-3 bg-[rgba(15,32,64,0.6)] backdrop-blur-md px-6 py-4 rounded-full border z-20 transition-colors ${hwStatus === 'connected' ? 'border-[rgba(33,150,243,0.2)] hover:bg-[rgba(15,32,64,0.8)]' :
      ...
      >
        <motion.div
          ...
          className={`w-3 h-3 rounded-full ${hwStatus === 'connected' ? 'bg-brand-success shadow-[0_0_12px_var(--color-brand-success)]' :
            ...
            <div className="relative w-40 h-24 flex items-center justify-center overflow-hidden">
              ...
              >
                ...
                >
                  ...
                  />
                  {/* Second heartbeat cycle (seamless continuation) */}
                  <motion.path
                    d={isHardwareConnected
                      ? "M0 50 L10 50 L15 45 L20 55 L25 50 L40 50 L45 70 L55 10 L65 90 L70 50 L85 50 L95 40 L105 50 L120 50 L125 45 L130 55 L135 50 L150 50 L155 70 L165 10 L175 90 L180 50 L200 50"
                      : "M0 50 L20 50 L25 48 L30 52 L35 50 L50 50 L55 52 L65 42 L75 58 L80 50 L120 50 L125 48 L130 52 L135 50 L150 50 L155 52 L165 42 L175 58 L180 50 L200 50"
      ...
      <div className="w-1/2 h-full flex flex-col items-center p-16 pt-32 z-10">
        ...
        <div className="flex bg-[rgba(15,32,64,0.5)] p-1.5 rounded-full mb-16 border border-[rgba(33,150,243,0.2)]">
          <button
            ...
            className={`px-8 py-3 rounded-full text-sm font-bold tracking-widest uppercase transition-all duration-300 ${language === 'en'
          ...
          <button
            ...
            className={`px-8 py-3 rounded-full text-sm font-bold tracking-widest uppercase transition-all duration-300 ${language === 'hi'
                ? 'bg-brand-primary text-text-primary shadow-[0_4px_12px_rgba(33,150,243,0.4)]'
                : 'text-text-muted hover:text-text-secondary'
              }`}
          >
